...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2022 at 02:45 PM
...
(1, 1, 'Rishabh Sharma', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
(2, 1, 'Nishant Kumar', 'You just have to arrive at the place, it\'s fully furnished and stocked with all basic amenities and services and even your friends are welcome.'),
...
(13, 'rishabh@gmail.com', '45f106ef4d5161e7aa38cf6c666607f25748b6ca', 'Rishabh Sharma', '9858942645', 'male', 'Chandigarh University'),
(14, 'asha@gmail.com', '45f106ef4d5161e7aa38cf6c666607f25748b6ca', 'Asha', '4858942645', 'female', 'xyz');
...
--
ALTER TABLE `interested_users_properties`
  ADD CONSTRAINT `interested_users_properties_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `interested_users_properties_ibfk_2` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
